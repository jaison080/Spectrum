...
//         <p className="card-text">{showFullText ? props.article : truncatedText}</p>
//         {!showFullText && words.length > maxWordsToShow && (
//           <button className="btn btn-link" onClick={handleShowMoreClick}>
//             Read More
//           </button>
//         )}
//         {showFullText && (
...
//           </button>
//         )}
//         <JobDate date={new Date (props.date)} />
...
//               Show Comments
//             </button>
//             <button className="btn btn-primary" onClick={handleHideComments}>
//               Hide Comments
//             </button>
//           </div>
//         </div>
...
//                 <textarea className="form-control" name="comment" rows="3" placeholder="Add a comment"></textarea>
//               </div>
...
//                     <div>Commenter: {comment.commenter.name}</div>
//                   </div>
//                 ))}
//               </div>
//             ))}
